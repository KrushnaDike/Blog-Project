          ...
          <div className="col-span-4">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="overflow-hidden flex" id="shopping-tips">
                <div className="p-4">
                  <p className="text-gray-700">
                    Discover insightful tips for shopping ingredients and
                    kitchen essentials. Learn to prioritize freshness and
                    quality when selecting produce and meats. Opt for versatile
                    pantry staples like grains, spices, and oils to enhance your
                    cooking options. Utilize seasonal produce for better flavor
                    and cost-effectiveness. Compare prices across different
                    stores and consider bulk buying for items you frequently
                    use. Don't forget to check expiration dates and storage
                    requirements to maximize shelf life. Invest in quality
                    kitchen tools and equipment that suit your cooking style and
                    needs.
                  </p>
                </div>
                <img
